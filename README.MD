...
- **"export_embeddings":** This mode combines the embeddings based on the content length and exports them in NDJSON format to a GCS bucket. `data-store-ml-spez-ccai
`
